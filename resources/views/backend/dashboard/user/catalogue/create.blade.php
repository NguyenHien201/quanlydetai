...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  @php
    $url = ($config['method'] == 'create') ? route('userCatalogue.store') : route('userCatalogue.update', $userCatalogue->id);
  @endphp
    ...
    <div class="row mb30">
      <div class="col-lg-5">
        <div class="panel-head">
          <div class="panel-title">Thông tin quyền người dùng</div>
          <div class="panel-description">
            <p>Nhập thông tin liên quan đến quyền người dùng</p>
      ...
      <div class="col-lg-7 card">
        <div class="card-body">
          <div class="row mb10">
            <div class="col-lg-6">
              <div class="form-row">
                <label for="" class="control-label text-right">Tên quyền <span class="text-danger">(*)</span></label>
                <input 
                  type="text"
                  id=""
                  name="name"
