<form action="{{route('userCatalogue.index')}}">
          ...
          <div class="uk-flex uk-flex-middle">
            ...
            <div class="uk-flex uk-flex-middle">
              <div class="create-btn">
                ...
                <a href="" class="btn btn-warning mr10"><i class='bx bxs-key'></i></i> Phân quyền</a>
              </div>
              <div class="create-btn">
                <a href="{{route('userCatalogue.create')}}" class="btn btn-primary"><i class='bx bx-plus'></i> Thêm mới</a>
              </div>
            </div>
          </div>
        </div>
